import { rawInput } from "./inputs/Day5Input.js";
...
var max = findMaxOf3DArr(input);

var grid1 = make2DArr(max, max);
fillGrid(grid1, input, false);

var part1CountOver2 = getCountAbove(grid1, 1);
// console.log("Part 1 answer is: " + part1CountOver2);

// ===== Part 2 =====

var grid2 = make2DArr(max, max);
fillGrid(grid2, input, true);

var part2CountOver2 = getCountAbove(grid2, 1);
// console.log("Part 2 answer is: " + part2CountOver2);

export { part1CountOver2, part2CountOver2 };
